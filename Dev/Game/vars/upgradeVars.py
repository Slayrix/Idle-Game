...
matterGenUpgrade = upgradeClass.genUpgrade(.15, currencyVars.matter, 6, currencyVars.matter, "*", 2, currencyVars.matter, "+", 10)

genEnergyUpgradeBuff = upgradeClass.upgradeBuff(.5, currencyVars.matter, genEnergyUpgrade, "increaseGenPerSecondAmount", "*", 2)