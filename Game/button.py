...
energyCheatButton = button(["Add Energy"], ["cheats"], (255, 255, 255), 0, 0, buttonGroup.cheatsButtonGroup, ["cheat", currency.energy])
matterCheatButton = button(["Add Matter"], ["cheats"], (255, 255, 255), 0, 0, buttonGroup.cheatsButtonGroup, ["cheat", currency.matter])
...
matterGenUpgradeButton = button(["Double Matter Generation", "Increases energy consumption by +10", str(upgrade.matterGenUpgrade.cost) + " Matter"], ["shop"], (255, 255, 255), 0, 0, buttonGroup.upgradeButtonGroup, ["buyUpdrade", upgrade.matterGenUpgrade], None, [[[[upgrade.matterGenUpgrade, "cost"], " Matter"], 2]])
genEnergyUpgradeBuffButton = button(["Double Energy Generation of Upgrade 1", str(upgrade.genEnergyUpgradeBuff.cost) + " Matter"], ["shop"], (255, 255, 255), 0, 0, buttonGroup.upgradeButtonGroup, ["buyUpdrade", upgrade.genEnergyUpgradeBuff])
